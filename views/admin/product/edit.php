<div class="row">
    <form action="<?= BASE_URL_ADMIN . '&action=product-update&id=' .$pro['id'] ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3 mt-3">
            ...
            <select class="form-control" id="category_id" name="category_id" value="<?= $pro['category_id'] ?>">
        ...
        <div class="mb-3 mt-3">
            ...
            <input type="date" class="form-control" id="created_at" name="created_at" value="<?= $pro['created_at'] ?>">
        </div>
        <div class="mb-3">
            <label for="img_cover" class="form-label">Ảnh:</label>
